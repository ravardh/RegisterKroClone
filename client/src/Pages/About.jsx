...
const About = () => {
  return (
    <>
      <section className="hero-section -mt-16 flex flex-col items-center justify-center h-screen bg-[url('/hero.jpg')] opacity-90 bg-cover bg-center">
        <div className="hero-content px-6 sm:px-20 md:px-50 py-10 ">
