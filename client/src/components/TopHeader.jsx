      ...
      <div className="bg-(--primary) sticky top-0 z-60">
        <div className="max-w-[min(95%,calc(100vw-1rem))] mx-auto px-3 sm:px-5">
          <div className="flex gap-2 sm:gap-4 md:gap-6 py-1.5 sm:py-2 justify-between items-center">
            ...
            <div
              className="rounded cursor-pointer overflow-hidden flex items-center justify-center gap-2"
              onClick={() => navigate("/")}
            >
             <div className="w-24 h-10 sm:w-32 sm:h-12 flex items-center justify-center p-0.5 bg-white">
               <img
