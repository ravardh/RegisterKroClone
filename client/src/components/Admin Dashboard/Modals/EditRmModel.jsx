...
const EditRmModal = ({ isOpen, onClose, onUpdateManager, manager }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`/admin/update-rm/${manager._id}`, updateData);
      if (res.data.data) {
        onUpdateManager(res.data.data);
        setFormData({
          fullName: "",
          email: "",
          phone: "",
      ...
      setError(
        error.response?.data?.message || "Failed to update relationship manager"
      );
    } finally {
      setLoading(false);
    }
