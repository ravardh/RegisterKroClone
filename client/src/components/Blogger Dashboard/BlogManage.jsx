...
import { MdAdd, MdEdit, MdVisibility, MdVisibilityOff } from "react-icons/md";
import toast from "react-hot-toast";
import axios from "../../config/api";
import CreateBlog from "../../pages/CreateBlog";
import { useTable } from "../../hooks/useTable";
import { SortableHeader, TablePagination, SearchBar } from "../Admin Dashboard/TableComponents";
import clsx from "clsx";

const BloggerBlogManage = () => {
  ...
  const fetchBlogs = async () => {
    try {
      setLoading(true);
      const res = await axios.get("/blogger/blogs");
  ...
  const handleVisibilityToggle = async (blog) => {
    ...
    try {
      const res = await axios.patch(`/blogger/blogs/${blog._id}/visibility`, {
...
export default BloggerBlogManage;
