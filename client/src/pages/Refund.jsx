...
const Refund = () => {
  const refundSchema = {
    ...
    name: "Refund Policy",
    description:
      "TaxProSolution Refund Policy - How refunds are handled for our business services",
  };

  return (
    <>
      <SEOHelmet
        title="Refund Policy - TaxProSolution"
        description="Read TaxProSolution's refund policy to understand eligibility, timelines, and how refund requests are processed."
