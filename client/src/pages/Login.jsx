...
const Login = () => {
  const loginSchema = {
    ...
    "@type": "LoginAction",
    "name": "Login to Tax Pro Solution",
  ...
  return (
    <>
      <SEOHelmet
        title="Login - Tax Pro Solution Dashboard"
        description="Login to your Tax Pro Solution account to manage applications, track status, and access personalized services."
        keywords="login, signin, account, dashboard access"
        canonicalUrl="https://taxprosolution.co.in/login"
        structuredData={loginSchema}
      />
      <div>
        <div className="min-h-screen bg-[url(/hero.webp)] bg-center bg-cover -mt-20 flex items-center justify-center bg-(--root) px-4">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-2 rounded-md bg-(--success) text-white hover:bg-(--success-hover) transition-colors"
            >
              Sign in
            </button>
          </form>
